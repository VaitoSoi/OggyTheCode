...
module.exports = {
    ...
    run: async (client, message, args) => {
        if (!message.member.permissions.has("KICK_MEMBERS")) return message.channel.send('Bạn không có quyền `KICK_MEMBERS`')
        if (!message.guild.me.permissions.has("KICK_MEMBERS")) return message.channel.send('Tôi không có quyền `KICK_MEMBERS`')
